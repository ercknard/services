...
var Footer = /** @class */ (function (_super) {
    ...
    Footer.prototype.render = function () {
        return (react_1["default"].createElement("footer", { className: "footer" },
            ...
            react_1["default"].createElement("div", { className: "text-motion section-title-logo to-octa team-title" },
                " ",
                "\u2756",
                " "),
            react_1["default"].createElement("ul", { className: "menu" },
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "#offers" }, "Offers")),
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "#services" }, "Security")),
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "#team" }, "Team")),
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "https://metrix.place/", target: "_blank" }, "Metrix.Place")),
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "https://cryptechtest.xyz/", target: "_blank" }, "CryptechTest")),
                react_1["default"].createElement("li", { className: "menu__item" },
                    react_1["default"].createElement("a", { className: "menu__link", href: "http://www.freepik.com", target: "_blank" }, "vectorpocket"))),
